 ...
 */
public class RecyclerviewHeaderFooter extends LinearLayout {
    ...
    public RecyclerviewHeaderFooter(Context context) {
        super(context);
    }

    public RecyclerviewHeaderFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RecyclerviewHeaderFooter(Context context, AttributeSet attrs, int defStyleAttr) {
