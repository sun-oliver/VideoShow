    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                int resDefault = ta.getResourceId(R.styleable.SmileBar_smileDefault, R.drawable.icon_reviews_star);
                int res1 = ta.getResourceId(R.styleable.SmileBar_smileDefault, R.drawable.icon_reviews_star);
                int res5 = ta.getResourceId(R.styleable.SmileBar_smileDefault, R.drawable.icon_reviews_star_hover);
